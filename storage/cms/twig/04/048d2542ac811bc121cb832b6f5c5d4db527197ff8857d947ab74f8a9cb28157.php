...
class __TwigTemplate_1edd5ef0fce800867cabb7c1d1629a638c26c0f7b968194871315ca807bc177e extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  \t\t\t\t</div> -->
    ...
    {
        return new Source("<div class=\"section frontpage-open1 bg-white\" id=\"open\">
    <div class=\"container\">
        <h2 class=\"block-title wow zoomIn\">Contáctanos</h2>
        <div class=\"wow fadeIn\">
            <!-- <p class=\"text-center\">On the left, we placed contact form.</p> -->
            ...
            <div class=\"row\">
                ...
                <div class=\"col-md-5\">
                    <h4>Escríbenos</h4>
                    <p align=\"justify\">Para mayor información escriba al correo electrónico: \"sic@ues.edu.sv\" o llame al teléfono: (+503) 2225 8434 o complete el formulario disponible en el siguiente enlace:</p>
                    <p><a href=\"{{'sicues/contactenos.htm' | page }}\" class=\"btn btn-primary-custom btn-margin-top\"><strong>Formulario de contacto</strong></a></p>
                    <div id=\"container\">
            \t<!-- <div id=\"left\">
            \t\t<img  src=\"{{ 'assets/images/samples/ues.jpg' | theme }}\" class=\"img-responsive\" />
            \t</div> -->
  \t\t\t\t<!-- <div id=\"right\">
  \t\t\t\t\t<img src=\"{{ 'assets/images/samples/reima.jpg' | theme }}\" class=\"img-responsive\" />
  \t\t\t\t</div> -->
  \t\t\t\t<!-- <div id=\"center\">
  \t\t\t\t\t<img src=\"{{ 'assets/images/samples/csuca.jpg' | theme }}\" class=\"img-responsive\" />
  \t\t\t\t</div> -->
            </div> <!--end container-->
        </div>
            </div>
...
</div>", "/websicues/themes/vojtasvoboda-vega/partials/sections/contact.htm", "");
    }
