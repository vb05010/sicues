...
class __TwigTemplate_1741535c0c9e9b360860f5acc74ec7093d1d3fe81334d2bf1ac48545fbfa6746 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-md-5\">
        {% partial 'modules/cicues' %}
    </div> <!-- end col-md-5-->
</div> <!-- end row-->", "/websicues/themes/vojtasvoboda-vega/pages/sicues/cic-ues.htm", "");
    }
