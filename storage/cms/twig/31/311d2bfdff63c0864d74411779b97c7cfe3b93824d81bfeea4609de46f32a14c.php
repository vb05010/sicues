...
class __TwigTemplate_430d26004f40de34adc083d662a81e4a986d87078e5f6af1a681a94c869a3f7f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <style type=\"text/css\">
        .qtranxs_flag_en {
            background-image: url({{ 'assets/images/flags/gb.png' | theme }}); background-repeat: no-repeat;
        }
        .qtranxs_flag_de {
...
<body class=\"{{ this.page.id }} page page-{{ this.page.id }} {% placeholder bodyclass %}\">
...
<div class=\"jumbotron banner-none\">
    <div class=\"container\">
        <h1 class=\"block-title wow zoomIn\" >{{ this.page.title }}</h1>
    </div>
</div>
...
<div class=\"section page-content bg-white\">
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-md-12\">
                <div class=\"page type-page status-publish hentry\">
                    <h3 class=\"page-title\">{{ this.page.title }}</h3>
                    <div class=\"page-content\">
                        {% page %}
                    </div>
                </div>
...
</html>", "/websicues/themes/vojtasvoboda-vega/layouts/titled.htm", "");
    }
