...
$(function(){    
    $('.view-pdf').on('click',function(){
        ...
        $.createModal({
            title:'Secretaría de Investigaciónes Científicas SIC-UES',
            message: iframe,
            closeButton:true,
            scrollable:false
        });
